...
<!-- syarifah -->
	...
	<div class="ads-grid">
		<div class="container">
			...
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Update ADMIN
			...
			<div class="modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Admin</h3>
                  <form action="updateadmin.php" method="post">
							<div class="styled-input agile-styled-input-top">
								<input type="text" placeholder="Username" name="a_username" value = '<?php echo $row['A_USERNAME']; ?>' >
							</div><br>
							<div class="styled-input">
								<input type="password" placeholder="Password" name="a_password" required="">
							</div><br>
                            <div class="styled-input">
								<input type="text" placeholder="Assistant ID" name="assistantid" value = '<?php echo $row['ASSISTANTID']; ?>' >
							</div><br>
