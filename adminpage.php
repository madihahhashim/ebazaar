...
<!-- syarifah -->
	...
	<div class="ads-grid">
		<div class="container">
			...
			<!-- tittle heading -->
			<h3 class="tittle-w3l">List Of ADMIN
			...
			<div class="col-lg-10" style="float:none;margin:auto;background-color:white;border-radius:4px;padding:20px;">
              <div class="card" style="background-color:white;">
                <div class="card-body">
                  <h3 class="card-title" style="font-weight:bold;">Admin</h3>
                ...
                oci_define_by_name($qry, 'A_USERNAME', $A_USERNAME);
                oci_define_by_name($qry, 'A_PASSWORD', $A_PASSWORD);
                        ...
                        $nrows = oci_fetch_all($qry,$res);
                            ...
                            for($i=0;$i<count($res['A_USERNAME']);$i++)
                            {
                               //echo count($res['A_USERNAME']);
                            ?>
                            <tr>
                              <td><?php echo $counter; ?></td>
                              <td><?php echo $res['A_USERNAME'][$i]; ?></td>
                              <td><?php echo $res['A_PASSWORD'][$i]; ?></td>
                                
                              <?php echo "<td><a href='updateadmin1.php?ADMINID=".($res['ADMINID'][$i])."'>Update</a></td>";?>
