				...
				<div class="wrapper">
					...
					<div class="product-sec1">
						...
						<div class="col-md-15 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<img src="..\bazaar\gambar\bentong.jpg" alt="BENTONG" width="50%" height="50%" onclick="window.location.href='bentong.php';">
								</div><br/>
					...
					<div class="product-sec1">
						...
						<div class="col-md-15 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
								<img src="..\bazaar\gambar\temerloh.jpg" alt="TEMERLOH" width="50%" height="50%" onclick="window.location.href='temerloh.php';">
								</div><br/>
					...
					<div class="product-sec1">
						...
						<div class="col-md-15 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
								<img src="..\bazaar\gambar\kuantan.jpg" alt="KUANTAN" width="50%" height="50%" onclick="window.location.href='kuantan.php';">
								</div><br/>
